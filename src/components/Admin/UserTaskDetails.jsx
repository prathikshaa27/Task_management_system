...
import{Card,Spinner,Alert,Badge,Button,Container} from "react-bootstrap";
import { BsArrowLeft, BsCalendar,BsTag,BsListCheck,BsPersonCircle } from "react-icons/bs";


export function UserTaskDetail(){
    const{id} = useParams();
    ...
    useEffect(()=>{
        ...
        return(
            ...
            <Card className="border-0 bg-white rounded-4 shadow-sm p-4">
                ...
                <p className="mb-2"><strong>Description: </strong>{task.description || "N/A"}
                </p>
                <p className="mb-2">
                    <strong>
