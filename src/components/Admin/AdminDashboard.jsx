...
export default function AdminDashboard(){
    return(
        <div className="container py-5" style={{height:"100vh",display:"flex", flexDirection:"column",overflow:"hidden"}}>
          <div style={{backgroundColor:"#f1f1f1",padding:"20px",borderRadius:"8px",flexShrink:0}}>
